> 📌 **Bản mẫu gốc của BTC — giữ lại để đối chiếu.** Đây là `README_boilerplate.md` nguyên văn BTC cấp (initial commit `4741ab8`), dùng để điền vào và copy đè thành `README.md` thật. Việc đó đã làm xong — xem [`/README.md`](../../../README.md) là bản đã điền. File này giữ lại làm ví dụ/tham chiếu cấu trúc BTC mong muốn (Problem → Solution → Target User → Tech Stack → Quick Start → Deliverables Checklist → Team), không phải file cần chỉnh sửa tiếp.
