...
(async () => {
  ...
  await page.waitForSelector('text=Kế hoạch đề xuất', { timeout: 30000 }).catch(() => console.log('plan text not found in time'));
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'layout_with_plan2.png', fullPage: true });
  await browser.close();
})();
